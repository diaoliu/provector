...
- <InlineIcon d={mdiAlignVerticalTop} /> Align Top
- <InlineIcon d={mdiAlignVerticalCenter} /> Align Middle
- <InlineIcon d={mdiAlignVerticalBottom} /> Align Bottom
- <InlineIcon d={mdiAlignHorizontalLeft} /> Align Left
- <InlineIcon d={mdiAlignHorizontalCenter} /> Align Center
- <InlineIcon d={mdiAlignHorizontalRight} /> Align Right
- <InlineIcon d={mdiAlignHorizontalDistribute} /> Horizontal Distribute objects evenly
- <InlineIcon d={mdiAlignVerticalDistribute} /> Vertical Distribute objects evenly
...
- <InlineIcon d={mdiReflectHorizontal} /> Flip Along
- <InlineIcon d={mdiReflectVertical} /> Flip Across
...
- In the layers panel, click the lock button <InlineIcon d={mdiLock} /> to lock or unlock an object.
...
- In the layers panel, click eye button <InlineIcon d={mdiEye} /> to show or hide an object.
