import { mdiContentCut, mdiSetCenterRight, mdiPerspectiveMore } from "@mdi/js";
...
2. Select the trim tool <InlineIcon d={mdiContentCut} /> from the toolbar.
...
1. Select two or more paths.
2. Select the shape builder tool <InlineIcon d={mdiSetCenterRight} /> from the toolbar.
...
2. Select the free transform tool <InlineIcon d={mdiPerspectiveMore} /> in the toolbar or press <kbd>e</kbd>.
