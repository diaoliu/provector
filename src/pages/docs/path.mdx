...
2. Do one of the following to close an open path or join two paths:
   - Press <kbd>Ctrl + J</kbd> on the keyboard.
   - With the direct selection tool active, in the anchors panel, click **Join Paths**.

## Quick Join Paths

1. Select one or more open paths.
2. Do one of the following to close an open path or join paths automatically by closest endpoints:
   - Press <kbd>Ctrl + J</kbd> on the keyboard.
   - With the direct selection tool active, in the anchors panel, click **Join Paths**.
